  ...
  return (
    <Fragment>
      <form className={css.form}>
        ...
        <strong className="text-light" style={{fontSize: "12px"}}>
          Password should be between 6 and 16 characters and should contain
          alteast one lower case, one upper case alphabhet, one number and one
          special character
        </strong>
      </form>
    </Fragment>
